...
class SecurityConfiguration(
    ...
    override fun configure(http: HttpSecurity) {
        http.cors().and()
            ...
            .and()
            .addFilterBefore(JwtAuthenticationFilter(authenticationManager(), objectMapper), UsernamePasswordAuthenticationFilter::class.java)
            .addFilterBefore(JwtAuthorizationFilter(authenticationManager()), BasicAuthenticationFilter::class.java)
            .exceptionHandling()
